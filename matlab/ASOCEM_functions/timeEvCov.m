function phi_ij = timeEvCov(f,PHI,mu,nu,mu0,s1_inv,logdet0,mu1,s2_inv,logdet1,dt,eta,Eps)
...
% time evaluation
% fidelity terms
RT = - nu + 0.5*(logdet1-logdet0)-0.5*((f-mu0)'*s1_inv*(f-mu0)-(f-mu1)'*s2_inv*(f-mu1));
